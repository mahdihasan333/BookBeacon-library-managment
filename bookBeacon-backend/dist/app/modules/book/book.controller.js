...
const createBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const validatedData = book_validation_1.createBookZodSchema.parse({ body: req.body }); // createBook এখনো body প্রত্যাশা করে
...
const updateBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const validatedData = book_validation_1.updateBookZodSchema.parse(req.body); // req.body সরাসরি পার্স করো
        const { bookId } = req.params;
